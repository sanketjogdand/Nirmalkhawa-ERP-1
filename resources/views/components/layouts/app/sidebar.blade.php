...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            @canany(['report.view', 'center_bill.view'])
                <flux:navlist.group expandable :heading="__('Reports')" class="lg:grid" :expanded="request()->routeIs('reports.*')">
                    ...
                    @can('center_bill.view')
                        <div class="px-1 py-2">
                            <div class="text-xs leading-none text-zinc-400">Center Billing</div>
                        </div>
                        <flux:navlist.item :href="route('reports.employees-centers.center-period-bill')" :current="request()->routeIs('reports.employees-centers.center-period-bill')" wire:navigate>{{ __('Center Period Bill') }}</flux:navlist.item>
                    @endcan
                </flux:navlist.group>
            @endcanany
            ...
            @canany(['supplier.view', 'deliveryexpense.view', 'expense_category.view', 'general_expense.view', 'supplierpayment.view', 'purchase.view', 'grn.view'])
                <flux:navlist.group expandable :heading="__('Supplier')" class="lg:grid" :expanded="request()->routeIs(['suppliers.*', 'delivery-expenses.*', 'expense-categories.*', 'general-expenses.*', 'supplier-payments.*', 'purchases.*', 'grns.*'])">
                    @can('supplier.view')
